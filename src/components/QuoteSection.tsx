    ...
    <section className="bg-[#222a44] py-24 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          colours, and design. True craftsmanship lies in how these elements come together to
          evoke comfort, elegance, and soul.
        </h2>
        <p
          className="text-white/40 text-base font-light leading-relaxed mb-8"
          style={{ fontFamily: "var(--font-raleway)" }}
        >
        ...
        <p className="text-white/40 text-sm mt-8 tracking-widest">Team Sapphire Premium Homes</p>
      </div>
    </section>
  );
}
